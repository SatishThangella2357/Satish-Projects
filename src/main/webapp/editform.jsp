...
<div class="container">
  ...
  <form action="/CandidateEvaluation/test/candidate/update" method="post" enctype="multipart/form-data">
    <input type="hidden" name="c_ID" value="${candidate.c_ID}" />
    <div class="form-group">
      <label for="c_Name">Candidate Name</label>
      <input type="text" name="c_Name" id="c_Name" class="form-control" value="${candidate.c_Name}">
    </div>
    <div class="form-group">
      <label for="c_Email">Candidate Email</label>
      <input type="text" name="c_Email" id="c_Email" class="form-control" value="${candidate.c_Email}">
    </div>
    <div class="form-group">
      <label for="c_Phone">Candidate Phone</label>
      <input type="text" name="c_Phone" id="c_Phone" class="form-control" value="${candidate.c_Phone}">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="date" name="c_RegDate" id="c_RegDate" class="form-control" value="${candidate.c_RegDate}">
    </div>
